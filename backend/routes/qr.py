...
FRONTEND_BASE = os.getenv('FRONTEND_URL', 'https://dunkin-demand-intelligence-9l6cla1z3.vercel.app')
...
if not FRONTEND_BASE or 'telligence' in FRONTEND_BASE:
    ...
    if not os.getenv('FRONTEND_URL'):
        print("[WARNING] FRONTEND_URL not set, using default: https://dunkin-demand-intelligence-9l6cla1z3.vercel.app")
    FRONTEND_BASE = 'https://dunkin-demand-intelligence-9l6cla1z3.vercel.app'
